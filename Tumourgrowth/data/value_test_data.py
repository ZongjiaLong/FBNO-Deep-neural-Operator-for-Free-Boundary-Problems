...
ContourDataPoint = namedtuple('ContourDataPoint',
                              [ 'fx',  'coord', 'value','initial_domain','processed_contour', 'mask'])
class ContourDataset(Dataset):
    def __init__(self, data_path, max_samples=800):
        ...
        for sample in raw_data:
            ...
            coord_tensor = torch.tensor(contour, dtype=torch.float32)
...
def create_dataloaders(data_path, batch_size=32, shuffle=True, max_samples=800,num_random_points=500
    ...
    return train_loader
# test_path = "F:\\Tumour\\picture\\boundary_data\\train_with_four\\all_test.npy"
# train_loader = create_dataloaders(test_path, batch_size=15,
